...
| non_pep420 | python2 | pip install . | python setup.py install | fail |
...
| non_pep420 | python2 | pip install -e . | python setup.py install | fail |
| non_pep420 | python2 | pip install -e . | python setup.py develop | pass |
| non_pep420 | python2 | python setup.py install | pip install . | fail |
| non_pep420 | python2 | python setup.py install | pip install -e . | fail |
| non_pep420 | python2 | python setup.py install | python setup.py install | pass |
| non_pep420 | python2 | python setup.py install | python setup.py develop | fail |
| non_pep420 | python2 | python setup.py develop | pip install . | pass |
| non_pep420 | python2 | python setup.py develop | pip install -e . | pass |
| non_pep420 | python2 | python setup.py develop | python setup.py install | fail |
...
| non_pep420 | python3 | pip install . | python setup.py install | fail |
...
| non_pep420 | python3 | pip install -e . | python setup.py install | fail |
| non_pep420 | python3 | pip install -e . | python setup.py develop | pass |
| non_pep420 | python3 | python setup.py install | pip install . | fail |
| non_pep420 | python3 | python setup.py install | pip install -e . | fail |
| non_pep420 | python3 | python setup.py install | python setup.py install | pass |
| non_pep420 | python3 | python setup.py install | python setup.py develop | fail |
| non_pep420 | python3 | python setup.py develop | pip install . | pass |
| non_pep420 | python3 | python setup.py develop | pip install -e . | pass |
| non_pep420 | python3 | python setup.py develop | python setup.py install | fail |
